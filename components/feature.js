...
class Feature extends IdyllComponent {
  ...
  render () {
    ...
    var featureChild = this.props.children.filter(c => c.type.__proto__ === FeatureContent)[0];
    var nonFeatureChildren = this.props.children.filter(c => c.type.__proto__ !== FeatureContent);
